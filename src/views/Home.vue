        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde las aplicaciones de mensajería hasta los sistemas de comercio electrónico, el funcionamiento de la web moderna depende, en gran medida, de los procesos que ocurren en el lado del servidor. Esta unidad introduce en el núcleo del desarrollo web, el back-end, proporcionando una comprensión sólida acerca de cómo los servidores procesan las solicitudes, cómo se diseñan y consumen las interfaces de programación de aplicaciones (APIs) y cómo se administra la información mediante bases de datos relacionales y NoSQL.
              
              p #[b Se invita a construir el motor de la web con seguridad, precisión y eficacia.]
